...
-IF I CHANGE TO < AND >, I CAN GET THE CORRECT ANSWER, BUT I DONT UNDERSTAND
-THE QUESTION ASKED FOR BETWEEN, SO IT SHOULD BE INCLUDED?
...
SELECT p.product_name,
		SUM(od.quantity) AS units_on_order
FROM products AS p
...
-I REALISED THE DIFFERENCE WHEN I CHANGE od.unit_price to p.unit_price
